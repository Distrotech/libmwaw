...
#ifndef __MWAW_GRAPHIC_DECODER_HXX__
#define __MWAW_GRAPHIC_DECODER_HXX__
...
*/
class MWAWGraphicDecoder : public MWAWPropertyHandler
{
public:
  /** constructor */
  MWAWGraphicDecoder(librevenge::RVNGDrawingInterface *output) : MWAWPropertyHandler(), m_output(output) { }
  /** destructor */
  ~MWAWGraphicDecoder() {};
