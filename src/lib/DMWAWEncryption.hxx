...
{
public:
  DMWAWEncryption(const char *password, const unsigned long encryptionStartOffset = 0);
  ~DMWAWEncryption();
...
private:
  ...
  DMWAWEncryption(const DMWAWEncryption &);
  DMWAWEncryption &operator=(const DMWAWEncryption &);
};
