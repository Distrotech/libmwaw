...
#ifndef __MWAW_SPREADSHEET_ENCODER_HXX__
#define __MWAW_SPREADSHEET_ENCODER_HXX__
...
/** main class used to define store librevenge::RVNGSpreadsheetInterface
    lists of command in a librevenge::RVNGBinaryData. \see MWAWSpreadsheetDecoder
...
*/
class MWAWSpreadsheetEncoder : public librevenge::RVNGSpreadsheetInterface
{
public:
  /// constructor
